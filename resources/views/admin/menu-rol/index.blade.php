                    ...
                    <tbody>
                        ...
                        @endif
                            ...
                            @foreach($menu["submenu"] as $key => $hijo)
                                <tr>
                                    <td style="padding-left:20px;"><i class="fa fa-arrow-right"></i> {{ $hijo["nombre"] }}</td>
                                    @foreach($rols as $id => $nombre)
                                        <td class="text-center">
                                            <input
                                            type="checkbox"
                                ...
                                @foreach ($hijo["submenu"] as $key => $hijo2)
                                    <tr>
                                        <td style="padding-left:30px;"><i class="fa fa-arrow-right"></i> {{$hijo2["nombre"]}}</td>
                                        @foreach($rols as $id => $nombre)
                                            <td class="text-center">
                                                <input
                                                type="checkbox"
                                    ...
                                    @foreach ($hijo2["submenu"] as $key => $hijo3)
                                        <tr>
                                            <td style="padding-left:40px;"><i class="fa fa-arrow-right"></i> {{$hijo3["nombre"]}}</td>
                                            @foreach($rols as $id => $nombre)
                                            <td class="text-center">
                                                <input
                                                type="checkbox"
